    ...
    class Profile {
        ...
        constructor(bearerToken) {
            ...
            this.getApiHero = (region, bnet, heroId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/profile/${bnet}/hero/${heroId}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getApiDetailedHeroItems = (region, bnet, heroId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/profile/${bnet}/hero/${heroId}/items?locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getApiDetailedFollowerItems = (region, bnet, heroId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/profile/${bnet}/hero/${heroId}/follower-items?locale=${locale}&access_token=${this.token.identifier}`);
            };
    ...
    class Item {
        ...
        constructor(bearerToken) {
            ...
            this.getItem = (region, itemSlugAndId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/item/${escape(itemSlugAndId)}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getItemTypeIndex = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/item-type?locale=${locale}&access_token=USLGWLnbFGMQ5lS1LQ0A4wnGukM1I18MvI`);
            };
            /**
            ...
            this.getItemType = (region, itemSlug, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/item-type/${escape(itemSlug)}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
    ...
    class Follower {
        ...
        constructor(bearerToken) {
            ...
            this.getFollower = (region, followerSlug, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/follower/${followerSlug}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
    ...
    class Act {
        ...
        constructor(bearerToken) {
            ...
            this.getAct = (region, actId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/act/${actId}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
    ...
    class ArtisanAndRecipe {
        ...
        constructor(bearerToken) {
            ...
            this.getArtisan = (region, artisanSlug, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/artisan/${artisanSlug}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getRecipe = (region, artisanSlug, recipeSlug, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/artisan/${artisanSlug}/recipe/${recipeSlug}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
    ...
    class CharacterAndSkill {
        ...
        constructor(bearerToken) {
            ...
            this.getCharacterClass = (region, classSlug, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/hero/${classSlug}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getApiSkill = (region, classSlug, skillSlug, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/d3/data/hero/${classSlug}/skill/${skillSlug}?locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
...
})(Diablo3 = exports.Diablo3 || (exports.Diablo3 = {}));
